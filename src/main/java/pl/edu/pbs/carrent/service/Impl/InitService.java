...
//
////        Role r1 = roleRepository.findByName(RoleName.ROLE_USER).orElseThrow(NoSuchElementException::new);
////        Role r4 = roleRepository.findByName(RoleName.ROLE_EMPLOYEE).orElseThrow(NoSuchElementException::new);
//        //add users
